...
function buildTests()
{
	...
	testCollection.addTest(new TestCase("Create DB shell", "index.html",
	[
		function(testRunner)
		{
			var dbShell = prepareDB();
			assertNotNull(dbShell, "DB connection failed.");
		}/*,
		function()
		{
	...
	testCollection.addTest(new TestCase("Populate DB", "index.html",
	[
		function(testRunner)
		{
